...
var FamilyType;
(function (FamilyType) {
    FamilyType["Default"] = "Helvetica Neue";
    FamilyType["Customize"] = "\"Roboto Mono\", monospace, Helvetica Neue";
...
var red$2 = '#F92855';
var alphaRed$2 = 'rgba(249, 40, 85, .7)';
var green$2 = '#2DC08E';
var alphaGreen$2 = 'rgba(45, 192, 142, .7)';
var grey = '#888888';
var white = '#FFFFFF';
var blue = '#1677FF';
var textColor = '#76808F';
var axisLineColor = '#DDDDDD';
var passageColor = 'rgba(0, 0, 0, 0.1)';
...
function getDefaultCandleStyle() {
    ...
    return {
        ...
        bar: {
            ...
            noChangeColor: grey,
            upBorderColor: red$2,
            downBorderColor: green$2,
            noChangeBorderColor: grey,
            upWickColor: red$2,
            downWickColor: green$2,
...
function createFont(size, weight, family) {
    return "".concat(weight !== null && weight !== void 0 ? weight : 'normal', " ").concat(size !== null && size !== void 0 ? size : 12, "px ").concat(family !== null && family !== void 0 ? family : FamilyType.Default);
}
/**
...
(function (ActionType) {
    ...
    ActionType["OnLineDoubleClick"] = "onLineDoubleClick";
    ActionType["OnLineDrawEnd"] = "onLineDrawEnd";
...
var OverlayImp = /** @class */ (function () {
    function OverlayImp(overlay) {
        ...
        this.isExclusionGetList = isExclusionGetList !== null && isExclusionGetList !== void 0 ? isExclusionGetList : false;
...
var TimeScaleStore = /** @class */ (function () {
    ...
    TimeScaleStore.prototype.setBarSpace = function (barSpace, adjustBeforeFunc) {
        var storeMinScale = this._chartStore.getMinScale();
        var storeMaxScale = this._chartStore.getMaxScale();
        var minScale = storeMinScale > BarSpaceLimitConstants.MIN ? storeMinScale : BarSpaceLimitConstants.MIN;
        var maxScale = storeMaxScale < BarSpaceLimitConstants.MAX ? storeMaxScale : BarSpaceLimitConstants.MAX;
        if (barSpace < minScale || barSpace > maxScale || this._barSpace === barSpace) {
            return;
        }
 ...
 * limitations under the License.
 */
var fibonacciBlockLine = {
    name: 'fibonacciBlockLine',
    totalStep: 3,
    needDefaultPointFigure: true,
    needDefaultXAxisFigure: true,
    needDefaultYAxisFigure: true,
    createPointFigures: function (_a) {
        ...
        if (coordinates.length > 0) {
            ...
            var endX_1 = bounding.width;
            if (coordinates.length > 1 && isNumber(points[0].value) && isNumber(points[1].value)) {
                var percents = [1, 0.5, 0];
                var colorAll_1 = ['#c52121', '#54cf23', '#5810ff'];
                var yDif_1 = coordinates[0].y - coordinates[1].y;
                var valueDif_1 = points[0].value - points[1].value;
                percents.forEach(function (percent, index) {
                    ...
                    //     baseline: 'bottom'
                    // });
                    // cccc_1.push({ color: colorAll_1[index], size: 4 });
                    var ggggg = [
                        {
                            type: 'line',
                            attrs: { coordinates: [{ x: startX_1, y: y }, { x: endX_1, y: y }] },
                            styles: { color: colorAll_1[index], size: 4 }
                        },
                        {
                            type: 'text',
                            isCheckEvent: false,
...
var horizontalRayLine = {
    ...
    needDefaultYAxisFigure: true,
    createPointFigures: function (_a) {
        var coordinates = _a.coordinates, bounding = _a.bounding, overlay = _a.overlay;
        ...
        if (typeof extendData !== 'undefined') {
            lineStyle.size = extendData[0].borderSize;
            lineStyle.color = extendData[0].borderColor;
        }
...
var parallelStraightLine = {
    ...
    createPointFigures: function (_a) {
        var coordinates = _a.coordinates, bounding = _a.bounding, overlay = _a.overlay;
        var lines = getParallelLines(coordinates, bounding);
        var extendData = overlay.extendData;
        var lineStyle = {
            color: blue
        };
        ...
        if (typeof extendData !== 'undefined') {
            lineStyle.color = extendData[0].borderColor;
            polygonStyle.color = hexToRGBA(extendData[0].borderColor, 0.2);
        }
        if (lines.length === 1) {
            return [
                {
...
var priceLine = {
    ...
    createPointFigures: function (_a) {
        ...
        if (typeof extendData !== 'undefined') {
            lineStyle.size = extendData[0].borderSize;
            lineStyle.color = extendData[0].borderColor;
            textStyle.color = extendData[0].textColor;
            textStyle.backgroundColor = extendData[0].bgColor;
        }
        return [
            {
                type: 'line',
...
var abcd = {
    ...
    createPointFigures: function (_a) {
        ...
        if (typeof extendData !== 'undefined') {
            lineStyle.color = extendData[0].borderColor;
            dashedLineStyle.color = extendData[0].borderColor;
            textStyle.color = extendData[0].textColor;
            textStyle.backgroundColor = extendData[0].bgColor;
        }
        var tags = ['A', 'B', 'C', 'D'];
        var texts = coordinates.map(function (coordinate, i) { return (__assign(__assign({}, coordinate), { baseline: 'bottom', text: "(".concat(tags[i], ")") })); });
        if (coordinates.length > 2) {
...
var overlays = {};
var extensions$1 = [
    fibonacciLine, fibonacciBlockLine, horizontalRayLine, horizontalSegment, horizontalStraightLine,
    parallelStraightLine, priceChannelLine, priceLine, rayLine, segment,
    straightLine, verticalRayLine, verticalSegment, verticalStraightLine, abcd,
...
var red$1 = '#F92855';
var green$1 = '#2DC08E';
var alphaRed$1 = 'rgba(249, 40, 85, .7)';
var alphaGreen$1 = 'rgba(45, 192, 142, .7)';
var candlestickColor = {
    candle: {
        bar: {
            upColor: red$1,
            downColor: green$1,
            upBorderColor: red$1,
            downBorderColor: green$1,
            upWickColor: red$1,
            downWickColor: green$1
        },
        priceMark: {
            last: {
                upColor: red$1,
...
var styles = {
    light: light,
    dark: dark,
    candlestickColor: candlestickColor,
    candlestickColorReverse: candlestickColorReverse
};
...
var ChartStore = /** @class */ (function () {
    ...
    ChartStore.prototype.adjustVisibleDataList = function () {
        var _a;
        this._visibleDataList = [];
        var _b = this._timeScaleStore.getVisibleRange(), realFrom = _b.realFrom, realTo = _b.realTo;
        var newRealFrom = realFrom;
        var newRealTo = realTo;
        if (realFrom >= 0 && this._dataList.length > 0 && ((_a = this._dataList[realFrom]) === null || _a === void 0 ? void 0 : _a.close) === null) {
            var dataList = this._dataList.filter(function (item) { return item.close; }).length;
            newRealTo = dataList;
            newRealFrom = dataList - 1;
        }
        for (var i = newRealFrom; i < newRealTo; i++) {
    ...
    ChartStore.prototype.setTheme = function (key, styles) {
        this._theme[key] = styles;
        return this;
    };
    ChartStore.prototype.getTheme = function () {
        return this._theme;
    };
    ChartStore.prototype.resetStyles = function (data) {
        var lineColor = data.lineColor, pointActiveBorderColor = data.pointActiveBorderColor, pointActiveColor = data.pointActiveColor, pointBorderColor = data.pointBorderColor, pointColor = data.pointColor, textBackgroundColor = data.textBackgroundColor, textColor = data.textColor, areaBackgroundColor = data.areaBackgroundColor, areaLineColor = data.areaLineColor, areaPointColor = data.areaPointColor, areaPointRippleColor = data.areaPointRippleColor;
        if (typeof lineColor !== 'undefined')
            this._styles.overlay.line.color = lineColor;
        if (typeof pointActiveBorderColor !== 'undefined')
            this._styles.overlay.point.activeBorderColor = pointActiveBorderColor;
        if (typeof pointActiveColor !== 'undefined')
            this._styles.overlay.point.activeColor = pointActiveColor;
        if (typeof pointBorderColor !== 'undefined')
            this._styles.overlay.point.borderColor = pointBorderColor;
        if (typeof pointColor !== 'undefined')
            this._styles.overlay.point.color = pointColor;
        if (typeof textBackgroundColor !== 'undefined')
            this._styles.overlay.text.backgroundColor = textBackgroundColor;
        if (typeof textColor !== 'undefined')
            this._styles.overlay.text.color = textColor;
        if (typeof areaBackgroundColor !== 'undefined') {
            this._styles.candle.area.backgroundColor = [
                {
                    color: areaBackgroundColor[0],
                    offset: 0
                },
                {
                    color: areaBackgroundColor[1],
                    offset: 1
                }
            ];
        }
        if (typeof areaLineColor !== 'undefined')
            this._styles.candle.area.lineColor = areaLineColor;
        if (typeof areaPointColor !== 'undefined')
            this._styles.candle.area.point.color = areaPointColor;
        if (typeof areaPointRippleColor !== 'undefined')
            this._styles.candle.area.point.rippleColor = areaPointRippleColor;
        return this;
    };
    ChartStore.prototype.getMinScale = function () {
        return this._minScale;
    };
    ChartStore.prototype.setMinScale = function (scale) {
        this._minScale = scale;
        return this;
    };
    ChartStore.prototype.getMaxScale = function () {
        return this._maxScale;
    };
    ChartStore.prototype.setMaxScale = function (scale) {
    ...
    ChartStore.prototype.addData = function (data, type, more) {
        return __awaiter(this, void 0, void 0, function () {
            var success, adjustFlag, dataLengthChange, dataCount, timestamp, lastDataTimestamp, lastBarRightSideDiffBarCount, emptyIndex;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (isArray(data)) {
                            ...
                            if (timestamp > lastDataTimestamp) { // 比最後一筆數據的時間搓大就新增
                            ...
                            else if (timestamp === lastDataTimestamp) { // 與最後一條數據的時間搓相同就覆蓋
                                this._dataList[dataCount - 1] = data;
                                success = true;
                                adjustFlag = true;
                            }
                            else { // 找到數據為空的第一筆覆蓋成新數據
                                emptyIndex = this._dataList.findIndex(function (i) { return i.close === null; });
                                if (emptyIndex !== -1) {
                                    this._dataList[emptyIndex] = data;
                                    success = true;
                                    adjustFlag = true;
                                }
                            }
        ...
        if (candleBarOptions !== null) {
            ...
            this.eachChildren(function (data, barSpace) {
                ...
                if (isValid(kLineData)) {
                    ...
                    var colors = [];
                    if (open_1 === null && high === null && low === null && close_1 === null)
                        return false;
                    if (close_1 > open_1) {
...
var OverlayView = /** @class */ (function (_super) {
            ...
            if (progressInstanceInfo !== null) {
                ...
                if (overlay.isDrawing() && progressInstancePaneId === paneId) {
                    ...
                    if (!overlay.isDrawing()) {
                        var pane_1 = _this.getWidget().getPane();
                        pane_1.getChart().getChartStore().getActionStore().execute(ActionType.OnLineDrawEnd, __assign(__assign({}, event), { overlay: overlay }));
    ...
    OverlayView.prototype._figureMouseDoubleClickEvent = function (overlay, _figureType, figureKey, figureIndex, _attrsIndex) {
        ...
        return function (event) {
            ...
            var pane = _this.getWidget().getPane();
            pane.getChart().getChartStore().getActionStore().execute(ActionType.OnLineDoubleClick, __assign(__assign({}, event), { overlay: overlay }));
            return true;
        };
    };
...
var CandleAreaView = /** @class */ (function (_super) {
    ...
    CandleAreaView.prototype.drawImp = function (ctx) {
        ...
        var lastDataIndex = dataList.findIndex(function (item) { return item.close === null; }) - 1;
        var bounding = widget.getBounding();
        var yAxis = pane.getAxisComponent();
        ...
        this.eachChildren(function (data) {
            ...
            if (isNumber(value)) {
                ...
                if (lastDataIndex >= 0 && data.dataIndex === lastDataIndex) {
...
var CandleLastPriceView = /** @class */ (function (_super) {
    ...
    CandleLastPriceView.prototype.drawImp = function (ctx) {
        ...
        if (priceMarkStyles.show && lastPriceMarkStyles.show && lastPriceMarkLineStyles.show) {
            var yAxis = pane.getAxisComponent();
            var dataList = chartStore.getDataList();
            var index = dataList.findIndex(function (item) { return item.close === null; });
...
var CandleLastPriceLabelView = /** @class */ (function (_super) {
    ...
    CandleLastPriceLabelView.prototype.drawImp = function (ctx) {
        ...
        var priceMarkStyles = chartStore.getStyles().candle.priceMark;
        var lastPriceMarkStyles = priceMarkStyles.last;
        var lastPriceMarkRectStyles = priceMarkStyles.last.rect;
        ...
        if (priceMarkStyles.show && lastPriceMarkStyles.show && lastPriceMarkTextStyles.show) {
            ...
            if (isValid(data)) {
                ...
                /* text = 1000.456 */
                var removedLastChar = text.slice(0, -1); // 1000.45
                var lastChar = text.slice(-1); // 6
                (_a = this.createFigure({
                    name: 'rect',
                    attrs: {
                        x: x + 2,
                        y: priceY - 12,
                        width: bounding.width - 4,
                        height: 24
                    },
                    styles: __assign(__assign({}, lastPriceMarkRectStyles), { color: backgroundColor })
                })) === null || _a === void 0 ? void 0 : _a.draw(ctx);
                (_b = this.createFigure({
                    name: 'text',
                    attrs: {
                        x: x + ctx.measureText(removedLastChar).width + 1,
                        y: priceY + 1,
                        height: 24,
                        text: lastChar,
                        align: textAlgin,
                    ...
                    styles: __assign(__assign({}, lastPriceMarkTextStyles), { size: 18, weight: 700 })
                })) === null || _b === void 0 ? void 0 : _b.draw(ctx);
                (_c = this.createFigure({
                    name: 'text',
                    attrs: {
                        ...
                        y: priceY + 6,
                        height: 24,
                        text: removedLastChar,
                        align: textAlgin,
                        baseline: 'middle'
                    },
                    styles: __assign({}, lastPriceMarkTextStyles)
                })) === null || _c === void 0 ? void 0 : _c.draw(ctx);
            }
        }
    };
                ...
                case WidgetNameConstants.X_AXIS: {
                    ...
                    if (!consumed) {
                        ...
                        if ((_d = xAxis === null || xAxis === void 0 ? void 0 : xAxis.getScrollZoomEnabled()) !== null && _d !== void 0 ? _d : true) {
                            ...
                            // 使用 event.pageX 有可能為 0 ，如果 scale 為 Infinity 或 NaN 會導致圖壞掉
                            if (isFinite(scale)) {
...
var ChartImp = /** @class */ (function () {
    ...
    ChartImp.prototype.setTheme = function (key, styles) {
        this.setStyles(styles);
        this._chartStore.setTheme(key, styles);
    };
    ChartImp.prototype.getTheme = function () {
        return this._chartStore.getTheme();
    };
    ChartImp.prototype.setInitStyles = function (styles) {
        this._chartStore.resetStyles(styles);
    };
    ChartImp.prototype.setMinScale = function (scale) {
        if (isNumber(scale) && scale > 0) {
            this._chartStore.setMinScale(Math.floor(scale));
        }
        else {
            this._chartStore.setMinScale(1);
        }
    };
    ChartImp.prototype.getMinScale = function () {
        return this._chartStore.getMinScale();
    };
    ChartImp.prototype.setMaxScale = function (scale) {
        var minScaleNum = this.getMinScale();
        var minScale = 1;
        if (isNumber(minScaleNum))
            minScale = minScaleNum;
        if (isNumber(scale) && scale > 1 && scale >= minScale) {
            this._chartStore.setMaxScale(Math.floor(scale));
        }
        else {
            this._chartStore.setMaxScale(50);
        }
    };
    ChartImp.prototype.getMaxScale = function () {
        return this._chartStore.getMaxScale();
    };
    ...
    ChartImp.prototype.createOverlay = function (value, paneId) {
        ...
        if (isString(value)) {
            ...
            var _a = value, name_1 = _a.name, other = __rest(_a, ["name"]);
            overlays = [__assign({ name: name_1 }, other)];
        }
    ...
    ChartImp.prototype.getOverlayList = function () {
        var data = this._chartStore.getOverlayStore().getInstances();
        return data.filter(function (v) { return !v.isExclusionGetList; });
    };
